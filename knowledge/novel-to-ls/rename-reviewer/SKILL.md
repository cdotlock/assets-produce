...
- `project_dir`:`lunascripts/<book-slug>/`
- `rename_map_path`:`lunascripts/<book-slug>/04.5-entity-rename/rename_map.json`
...
- **不做硬检查** — 残留 grep、LS integrity 由 `validate_rename.py` 负责,这里只看语义
