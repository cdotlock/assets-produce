...
1. **plan 包路径**:`lunascripts/{book-slug}/03-entity-planner/`
   - 必须包含:`00-structure-decision.md`、`01-common.md`、至少 2 份 `02+-route-*.md`、`README.md`
2. **Bible 包**(交叉参考用):`lunascripts/{book-slug}/02-character-architect/`
...
把 review 写成 `lunascripts/{book-slug}/03-entity-planner/route-review-{li_name}.md`。
...
```
lunascripts/{book-slug}/03-entity-planner/
