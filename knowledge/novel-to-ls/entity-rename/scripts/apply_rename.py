"""Apply rename_map.json to a lunascripts book."""
...
def build_replacement_pairs(
    ...
    for old_id, entry in rename_map.get("characters", {}).items():
        ...
        # This catches both LS speaker labels ("ALICE: hi") and narrative
...
def apply_to_project(project_dir: Path, rename_map: Dict[str, Any]) -> str:
    """Apply rename_map to every pipeline-stage file in a lunascripts book.
