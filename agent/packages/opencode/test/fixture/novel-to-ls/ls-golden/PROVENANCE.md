# LS Golden Fixtures — Provenance

## Source

- **Repository**: `cdotlock/novels-to-lunascript` (n2m)
...
## Files copied (3 golden .ls scripts)

| Fixture file | Absolute source path |
|---|---|
| `ep_10_weston_final.md` | `/Users/august/MobAI/novels-to-lunascript/lunascripts/no-rules-in-bad-ideas/05-episode-writer/scripts/ep_10_weston_final.md` |
| `ep_10_diego_final.md` | `/Users/august/MobAI/novels-to-lunascript/lunascripts/no-rules-in-bad-ideas/05-episode-writer/scripts/ep_10_diego_final.md` |
| `ep_11_luca_final.md` | `/Users/august/MobAI/novels-to-lunascript/lunascripts/no-rules-in-bad-ideas/05-episode-writer/scripts/ep_11_luca_final.md` |
...
episodes 10-11) and are representative of real multi-route LS output from the n2m pipeline.
...
The parity test (`test/business/novel-ls-compat.test.ts`) invokes `ls-validate` in
