...
describe("novel-to-ls corpus discovery", () => {
  ...
  it.live("opencode discovery sees all 11 novel-to-ls skills, filesystem-served", () =>
    Effect.gen(function* () {
      ...
      for (const name of EXPECTED) {
        ...
        expect(info!.location).toContain(path.join("knowledge", "novel-to-ls", name))
