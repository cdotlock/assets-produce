...
function buildTaskPrompt(side, testCase, workspace) {
  ...
  const shared = [
    ...
    "Do not call Bash, curl, videoctl, generate-image, generate-video, concat, crop, or remote skill tools.",
    "No local video tool checks are required in this AB run. Produce prompt artifacts from the provided files only.",
